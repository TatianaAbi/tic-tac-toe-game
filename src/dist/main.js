...
const winnerView = document.querySelector(".winner");
const loadSaves = document.querySelector(".load-saves");
const inputCol = document.querySelector("#height-map");
const inputRow = document.querySelector("#wide-map");
const inputGroup = document.querySelector("#group-map");
const createStart = document.querySelector("#start-game");
const player = document.querySelector(".game-name");
const textWinner = document.querySelector(".text-winner");
const map = document.querySelector(".game_container");
...
function handle(rowId, colId, matriz, jugador) {
    let ficha = jugador ? "⚫" : "⚪";
...
function renderMap(matriz, jugador, group) {
    map.innerHTML = "";
